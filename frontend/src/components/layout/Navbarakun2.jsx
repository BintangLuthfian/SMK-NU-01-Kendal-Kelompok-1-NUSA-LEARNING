        ...
        <>
          ...
          />
                ...
                <div className="navbar-end">
                    <a  href="/dashboard" className="text-sm text-black mr-[34px]">Beranda</a>
                    <a  href="/pusat-pengetahuan" className="underline underline-offset-2 font-bold text-sm text-black mr-[58px]">Pelatihan</a>
                    <LanguageDropdown/>
